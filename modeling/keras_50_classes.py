...
def multi_conv_model(class_labels, target_class=0):
    ...
    X = tf.keras.Input(shape=(img_size, img_size, num_channels))
    ...
    def loss_fn(y_true, y_pred):
        # https://stackoverflow.com/questions/61012727/how-can-i-pass-logits-to-sigmoid-cross-entropy-with-logits-before-i-fit-and-pred
    ...
    #     # keras.backend.set_session(sess) # DO I NEED THIS?
